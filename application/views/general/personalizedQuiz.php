<div class="container">
    <div class="row" style="height:100%;">
        <div class="col-12 col-md-6 p-5">
            <div id="q1">
                ...
                <select id="age-bracket" class="form-control">
                    ...
                    <option value="55to64">55 to 64 years</option>
                ...
                <small class="my-5 py-5"><p class="text-muted py-5"><strong>Note: </strong>These details are <strong>not sent to any server or shared with anyone</strong>. They stay on your device for your privacy. If you are not comfortable answering these questions, please view <a href="<?php echo site_url(['general', 'showCharts']); ?>">the health facts for everyone.</a></p></small>
            </div>
            <div id="q2">
        ...
        <div class="col-12 col-md-6 p-0 visualizationContainer" style="height:100%;">
